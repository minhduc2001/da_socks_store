    ...
    const handleSubmit = async (values: Record<string, string>) => {
        ...
        if (selectedAppointment) {
            updateAppointmentMutation.mutate(
                { id: selectedAppointment.id, data: { doctor_id: values.doctor_id, insurance: values.insurance, BHYT: values.BHYT } },
                {
                    onSuccess: () => {
                                ...
                                <Col span={12}>
                                    ...
                                    <FormGlobal>
                                        ...
                                        <ul className="mt-[-10px]">
                                            ...
                                            <FormItemGlobal name={`doctor_id`} className="!mb-[-4px]" required>
