...
export default function Tktheongay() {
    ...
    const { data } = useQuery(
        ["get_tk_theo_ngay", [serviceStatisticParams]],
        () => ApiStatistic.getTkTheoNgay(serviceStatisticParams)
    );
    ...
    return (
        <div className="service-statistic">
            <h1 className="text-center">BÁO CÁO DOANH THU KHÁM BỆNH VÀ ĐIỀU TRỊ THEO NGÀY</h1>
